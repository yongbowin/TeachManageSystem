...
<div class="content-center">
	...
	<s:form class="user-detail-content" action="do_edit_student_score" method="post">
		<input type="hidden" name="scoreStudentID" value='<s:property value="scoreStudentID" />' />
		
		<div class="user-detail-title">
			学号为-<s:property value="student_score_detail.student_id" />-的成绩
		</div>
		...
		<div>
			<table>
				...
				<tr>
					<td>学号：</td>
					<td><input value='<s:property value="student_score_detail.student_id" />' name="student_id" type="text" /></td>
				</tr>
